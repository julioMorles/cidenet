    ...
    useEffect(() => {
        axios.get('/api/empleados/' + id)
            .then(function (response) {
                ...
                setPrimer_apellido(empleado.primer_apellido)
                setSegundo_apellido(empleado.segundo_apellido)
                setPrimer_nombre(empleado.primer_nombre)
                setOtros_nombre(empleado.otros_nombre)
                setContry_id(empleado.contry_id)
                setType_id(empleado.type_id)
                setIdnumber(empleado.idnumber)
                let fecha = new Date(empleado.fecha_ingreso);
                setFecha_ingreso(fecha)
                setArea_id(empleado.area_id)
                setEmail(empleado.email)
            })
            .catch(function (error) {
                Swal.fire({
                    icon: 'error',
                    title: 'Error al buscar la informacion!',
